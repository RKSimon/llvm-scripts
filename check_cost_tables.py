...
def main():
  ...
  cpulevels = {
    ...
    "sse4.1"  : (128, ["penryn", "x86-64-v2", "silvermont", "goldmont", "tremont", "nehalem", "btver2", "sandybridge", "x86-64-v3", "broadwell", "haswell", "skylake", "alderlake", "znver1", "znver2", "znver3", "x86-64-v4", "skylake-avx512", "icelake-server", "sapphirerapids", "znver4"]),
